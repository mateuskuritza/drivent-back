...
export class CreateTicketAccomationHotelPurchaseRoom1630698831561 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      "CREATE TABLE \"tickets\" (\"id\" SERIAL NOT NULL, \"name\" character varying NOT NULL, \"price\" integer NOT NULL, CONSTRAINT \"PK_343bc942ae261cf7a1377f48fd0\" PRIMARY KEY (\"id\"))",
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "ALTER TABLE \"enrollments\" ADD CONSTRAINT \"UQ_25058561c95f2a9549b0e3cbfc4\" UNIQUE (\"purchaseId\")",
    );
    await queryRunner.query(
